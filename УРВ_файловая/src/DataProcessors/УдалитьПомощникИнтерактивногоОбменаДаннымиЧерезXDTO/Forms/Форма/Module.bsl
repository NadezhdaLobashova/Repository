...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СобытиеЖурналаРегистрацииЗагрузкаДанных = ОбменДаннымиСервер.КлючСообщенияЖурналаРегистрации(Объект.УзелИнформационнойБазы, Перечисления.ДействияПриОбмене.ЗагрузкаДанных);
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	ОбщегоНазначенияКлиент.ПоказатьПодтверждениеЗакрытияПроизвольнойФормы(ЭтотОбъект, Отказ, ЗавершениеРаботы, ТекстПодтверждения,
...
Процедура ОткрытьФормуСопоставления(Команда)
	...
	ОткрытьФорму("Обработка.СопоставлениеОбъектовXDTO.Форма", ПараметрыФормы, ЭтотОбъект);
...
Процедура ОбновитьИнформациюСопоставленияПоСтрокеНаСервере(Отказ, КлючиСтрок)
	...
	ВсеДанныеСопоставлены = Обработки.УдалитьПомощникИнтерактивногоОбменаДаннымиЧерезXDTO.ВсеДанныеСопоставлены(ОбработкаОбъект.ТаблицаИнформацииСтатистики());
...
Процедура АнализДанных()
	...
	Попытка
		...
		Если ОбщегоНазначения.ИнформационнаяБазаФайловая() Тогда
			...
			РезультатАнализа = Обработки.УдалитьПомощникИнтерактивногоОбменаДаннымиЧерезXDTO.РезультатАвтоматическогоСопоставленияДанных(
				Объект.УзелИнформационнойБазы,
		...
		Иначе
			...
			Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
				...
				"Обработки.ПомощникИнтерактивногоОбменаДаннымиЧерезXDTO.ВыполнитьАвтоматическоеСопоставлениеДанных",
				ПараметрыМетода,
...
Процедура ЗагрузкаДанных()
	...
	//		Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
	//			УникальныйИдентификатор,
	//			"Обработки.ПомощникИнтерактивногоОбменаДаннымиЧерезXDTO.ВыполнитьЗагрузкуДанных",
	//			ПараметрыМетода,
