...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ОбъектДляСопоставления.Заголовок = СтрШаблон(НСтр("ru='Объект в ""%1""'"), Параметры.Программа1);
		
	Элементы.Шапка.Заголовок = СтрШаблон(НСтр("ru='Объект в ""%1""'"), Параметры.Программа2);
