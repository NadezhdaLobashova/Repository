...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
    ...
    ОбщегоНазначенияУСПКлиентСервер.УстановитьДоступностьЭлементаФормы(ЭтотОбъект, "ФормаБизнесПроцессПоручениеСоздатьПоручение", Ложь);
    ОбщегоНазначенияУСПКлиентСервер.УстановитьДоступностьЭлементаФормы(ЭтотОбъект, "ГруппаПринятьКИсполнению", Ложь);
