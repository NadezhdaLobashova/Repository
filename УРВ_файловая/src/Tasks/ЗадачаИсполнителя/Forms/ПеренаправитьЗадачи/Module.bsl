...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Роль = Справочники.РолиИсполнителей.СотрудникЛинииПоддержки;
	...
	ОсновнойОбъектАдресации = СведенияОПользователе.ОбслуживающаяОрганизация;
	ДополнительныйОбъектАдресации = СведенияОПользователе.ЛинияПоддержки;
	
	Если Параметры.КоличествоЗадач = 1 Тогда
		Исполнители = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Параметры.Задача, 
                      Новый Структура("Проверяющий, Автор", "БизнесПроцесс.Автор", "БизнесПроцесс.Проверяющий"));
		Исполнитель = Исполнители.Проверяющий;
		Если Не ЗначениеЗаполнено(Исполнитель) Тогда
			Исполнитель = Исполнители.Автор;
		КонецЕсли;
