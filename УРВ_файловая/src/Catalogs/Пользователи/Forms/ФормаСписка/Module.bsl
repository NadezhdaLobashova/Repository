...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбменСОБД = URMExchangeСервер.ПолучитьКонстантуОбменСОБД();
	...
	Если РольДоступна("ИТ_Служба") И НЕ РольДоступна("ПолныеПрава") Тогда
	//astyul, 71975, 10.09.2018
...
Процедура ПриОткрытии(Отказ)
	...
	Элементы.СоздатьURMExchange.Видимость = ОбменСОБД;
...
// {Рарус_shav 2018.06.15 
&НаКлиенте
Процедура СоздатьURMExchange(Команда)
		
	ИмяОперации = "GetEmployee";
