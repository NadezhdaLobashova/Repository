...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	ОткрытьФорму("Справочник.Консультации.ФормаОбъекта", ПараметрыФормы, Элементы.Список);
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыТоп10
...
&НаКлиенте
Процедура Топ10ПередНачаломИзменения(Элемент, Отказ)
    
    Если Элементы.Топ10.ТекущиеДанные <> Неопределено Тогда
        ПоказатьЗначение(, Элементы.Топ10.ТекущиеДанные.Ссылка);
    КонецЕсли;
...
Процедура ГиперссылкаНастроитьНажатие(Элемент)
	...
	ПараметрыФормы.Вставить("ИспользоватьОтображатьЗакрытые", Ложь);
	ПараметрыФормы.Вставить("ОтображатьЗакрытые", ОтображатьЗакрытые);
	ПараметрыФормы.Вставить("ТипКарточек", "Консультации");
