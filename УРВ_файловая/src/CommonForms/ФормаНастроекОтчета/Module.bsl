...
Процедура ЗаполнитьКомандыВыбораПользовательскихНастроек()
	//// {Рарус_shav 2018.06.18 
	//Если НастройкиОтчета.Свойство("ХранилищеПользовательскихНастроек") И ЗначениеЗаполнено(НастройкиОтчета.ХранилищеПользовательскихНастроек) Тогда
	//// }Рарус_shav 2018.06.18 	
