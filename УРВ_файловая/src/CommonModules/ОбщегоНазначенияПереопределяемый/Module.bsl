...
Процедура ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики) Экспорт
	...
	Обработчики.Вставить("ВзаимоотношениеОбслуживающаяОрганизацияАбонент",   "ОбщегоНазначенияУСП.УстановкаПараметровСеанса");
	Обработчики.Вставить("ВзаимоотношениеПровайдерАбонент", 			     "ОбщегоНазначенияУСП.УстановкаПараметровСеанса");
	Обработчики.Вставить("ВзаимоотношениеПровайдерОбслуживающаяОрганизация", "ОбщегоНазначенияУСП.УстановкаПараметровСеанса");
	Обработчики.Вставить("ПустаяОбслуживающаяОрганизация", 					 "ОбщегоНазначенияУСП.УстановкаПараметровСеанса");
