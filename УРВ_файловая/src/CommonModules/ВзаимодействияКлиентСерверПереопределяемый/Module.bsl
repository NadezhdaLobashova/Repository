...
Процедура ПриОпределенииВозможныхПредметов(ТипыПредметов) Экспорт
	...
	ТипыПредметов.Добавить("ДокументСсылка.Обращение");
	ТипыПредметов.Добавить("СправочникСсылка.Пожелания");
...
Процедура ПриОпределенииВозможныхКонтактов(ТипыКонтактов) Экспорт
	...
	Контакт.Тип = Тип("СправочникСсылка.ПользователиСервисов");
	Контакт.Имя = "ПользователиСервисов";
	Контакт.Представление = НСтр("ru = 'Пользователи сервиса'");
