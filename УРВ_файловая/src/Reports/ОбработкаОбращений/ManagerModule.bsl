...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	//НастройкиОтчета.Описание = НСтр("ru = '...'");
	НастройкиОтчета.ОпределитьНастройкиФормы = Ложь;
	
	НастройкиВарианта = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ОбработкаОбращенийЛиниямиПоддержки");
	НастройкиВарианта.Описание = НСтр("ru = 'Ежедневные показатели работы линий поддержки.'");
