...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
    ...
    Список.Параметры.УстановитьЗначениеПараметра("СостояниеДубль", Перечисления.СостоянияПожеланий.Дубль);
...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	ОткрытьФорму("Справочник.Пожелания.ФормаОбъекта", ПараметрыФормы,Элементы.Список);
...
Процедура ГиперссылкаНастроитьНажатие(Элемент)
	...
	ПараметрыФормы.Вставить("ТипКарточек", "Пожелания");
