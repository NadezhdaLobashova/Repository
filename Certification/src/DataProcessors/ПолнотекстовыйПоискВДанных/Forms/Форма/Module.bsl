...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Массив = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("ПолнотекстовыйПоискСтрокиПолнотекстовогоПоиска", "СписокВыбора");
...
Процедура Искать(Направление, Отказ = Неопределено)
	...
	Иначе
		...
		ТекстПоиска = ТекстПоиска = НСтр("ru = 'Искомая комбинация слов нигде не встречается.<br><br>
			|<b>Рекомендации:</b>
