...
Процедура ВыполнитьДействияПередЗаписьюПрисоединенногоФайлаОбработчик(Источник) Экспорт
...
Процедура ВыполнитьДействияПередУдалениемПрисоединенногоФайлаВзаимодействияПередУдалением(Источник, Отказ) Экспорт
	// Вставить содержимое обработчика.
КонецПроцедуры
...
Процедура ВыполнитьДействияПриЗаписиПрисоединенногоФайлаВзаимодействияПриЗаписи(Источник, Отказ) Экспорт
	// Вставить содержимое обработчика.
КонецПроцедуры
