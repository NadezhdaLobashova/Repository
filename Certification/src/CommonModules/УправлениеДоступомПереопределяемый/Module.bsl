...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "КомпонентыСервиса";
	ВидДоступа.Представление = НСтр("ru = 'Компоненты сервиса'");
	ВидДоступа.ТипЗначений   = Тип("СправочникСсылка.КомпонентыСервиса");
	
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "ОбслуживающиеОрганизации";
	ВидДоступа.Представление = НСтр("ru = 'Обслуживающие организации'");
	ВидДоступа.ТипЗначений   = Тип("СправочникСсылка.ОбслуживающиеОрганизации");
...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// Профиль "Менеджер службы поддержки".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();;
	ОписаниеПрофиля.Имя = "МенеджерСлужбыПоддержки";
	ОписаниеПрофиля.Идентификатор  = "84e328a4-c155-11e3-8edb-bcaec5d6c3e4";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Менеджер службы поддержки'");
	ОписаниеПрофиля.Описание = НСтр("ru = 'Менеджер службы поддержки'");
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	...
	ОписаниеПрофиля.Роли.Добавить("РазделОбслуживание");
	ОписаниеПрофиля.Роли.Добавить("ПросмотрОтчетаВремяОбработкиЗакрытыхОбращений");
	ОписаниеПрофиля.Роли.Добавить("ПросмотрОтчетаОбработкаОбращений");
	ОписаниеПрофиля.Роли.Добавить("ПросмотрОтчетаАнализКарточекБазыЗнаний");
	ОписаниеПрофиля.Роли.Добавить("ПросмотрОтчетаАнализОбращений");
	ОписаниеПрофиля.Роли.Добавить("ПросмотрОтчетаОбращенияВРаботе");
	ОписаниеПрофиля.Роли.Добавить("ПросмотрОтчетаДвижениеОбращений");
	ОписаниеПрофиля.Роли.Добавить("ПросмотрОтчетаДлительностьОбработкиОбращений");
	ОписаниеПрофиля.Роли.Добавить("ПросмотрОтчетаЗатратыВремени");
	ОписаниеПрофиля.Роли.Добавить("ПросмотрОтчетаСтоимостьПоддержки");
	...
	ОписаниеПрофиля.Роли.Добавить("РазделАдминистрированиеОбслуживаниеСервисов");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПрава");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваУСП");
	...
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеНовостей");
    ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеСоглашений");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеЛинийПоддержки");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеОбращений");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеВзаимодействий");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеПриглашенийДляРегистрации");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеКонсультаций");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеОшибок");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеПожеланий");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеПоручений");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеПользователейСервиса");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеШаблоновТекстов");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеАбонентов");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеРазделов");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеФактическихТрудозатрат");
	ОписаниеПрофиля.Роли.Добавить("КонтрольФактическихТрудозатрат");
	ОписаниеПрофиля.Роли.Добавить("ИзменениеВыполнениеЗадач");
	ОписаниеПрофиля.Роли.Добавить("ИзменениеДополнительныхСведений");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеИнформацииПоСервисам");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеОбслуживающихОрганизаций");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеИзменениеКонтактнойИнформации");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеШаблоновБизнесПроцессов");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеБазовойНСИ");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеИсторииСобытий");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеПриложений");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеПодписокНаТарифы");
	ОписаниеПрофиля.Роли.Добавить("ПросмотрЖурналаВзаимодействий");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеПапокИФайлов");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеКомментариев");
	ОписаниеПрофиля.ВидыДоступа.Добавить("Сервисы", "ВначалеВсеРазрешены");
	ОписаниеПрофиля.ВидыДоступа.Добавить("КомпонентыСервиса", "ВначалеВсеРазрешены");
	ОписаниеПрофиля.ВидыДоступа.Добавить("ОбслуживающиеОрганизации", "ВначалеВсеРазрешены");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	// Профиль "Менеджер обслуживающей организации".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();;
	ОписаниеПрофиля.Имя = "МенеджерОбслуживающейОрганизации";
	ОписаниеПрофиля.Идентификатор = "84e328a5-c155-11e3-8edb-bcaec5d6c3e4";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Менеджер обслуживающей организации'");
	ОписаниеПрофиля.Описание = НСтр("ru = 'Менеджер обслуживающей организации'");
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТолстогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("СохранениеДанныхПользователя");
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеСоглашений");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеИнформацииПоСервисам");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеПриложений");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеПодписокНаТарифы");
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеШаблоновБизнесПроцессов");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеШаблоновТекстов");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеИзменениеКонтактнойИнформации");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеИсторииСобытий");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеПапокИФайлов");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеКомментариев");
	ОписаниеПрофиля.ВидыДоступа.Добавить("Сервисы");
	ОписаниеПрофиля.ВидыДоступа.Добавить("КомпонентыСервиса", "ВначалеВсеРазрешены");
	ОписаниеПрофиля.ВидыДоступа.Добавить("ОбслуживающиеОрганизации");
	ОписаниеПрофиля.ВидыДоступа.Добавить("ДополнительныеСведения");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);

	// Профиль "Консультант службы поддержки".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();;
	ОписаниеПрофиля.Имя = "КонсультантСлужбыПоддержки";
	ОписаниеПрофиля.Идентификатор = "84e328a6-c155-11e3-8edb-bcaec5d6c3e4";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Консультант службы поддержки'");
	ОписаниеПрофиля.Описание = НСтр("ru = 'Консультант службы поддержки'");
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТолстогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("СохранениеДанныхПользователя");
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеСоглашений");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеОбслуживающихОрганизаций");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеЛинийПоддержки");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеПожеланий");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеПриложений");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеПодписокНаТарифы");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеШаблоновБизнесПроцессов");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеШаблоновТекстов");
	...
	// Профиль "Консультант обслуживающей организации".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя = "КонсультантОбслуживающейОрганизации";
	ОписаниеПрофиля.Идентификатор = "84e328a7-c155-11e3-8edb-bcaec5d6c3e4";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Консультант обслуживающей организации'");
	ОписаниеПрофиля.Описание = НСтр("ru = 'Консультант обслуживающей организации'");
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТолстогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("СохранениеДанныхПользователя");
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеОшибок");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеПожеланий");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеАбонентов");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеПользователейСервиса");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеПриложений");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеПодписокНаТарифы");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеШаблоновБизнесПроцессов");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеШаблоновТекстов");
	...
	// Профиль "Эксперт службы поддержки".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя = "ЭкспертСлужбыПоддержки";
	ОписаниеПрофиля.Идентификатор = "b8304928-0cbf-11e4-92c1-bcaec5d6c3e4";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Эксперт службы поддержки'");
	ОписаниеПрофиля.Описание = НСтр("ru = 'Эксперт службы поддержки'");
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТолстогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("СохранениеДанныхПользователя");
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя = "ЭкспертОбслуживающейОрганизации";
	ОписаниеПрофиля.Идентификатор = "0b335d36-4e2a-11e4-9542-bcaec5d6c3e4";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Эксперт обслуживающей организации'");
	ОписаниеПрофиля.Описание = НСтр("ru = 'Эксперт службы поддержки'");
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТолстогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
