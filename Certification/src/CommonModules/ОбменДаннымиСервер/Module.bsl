...
Функция ОбработкаОбменаДаннымиДляВыгрузки(СтруктураНастроекОбмена) Экспорт
...
Функция ОбработкаОбменаДаннымиДляЗагрузки(СтруктураНастроекОбмена) Экспорт
...
Процедура ФормаНастройкиУзлаОбработчикПриСозданииНаСервере(Форма, ИмяРеквизитаФормы)
	...
	Для Каждого НастройкаОтбора Из Форма[ИмяРеквизитаФормы] Цикл
		...
		Иначе
			...
			Если Форма.Параметры.Свойство(ИмяРеквизитаФормы) Тогда
				Форма[Ключ] = Форма.Параметры[ИмяРеквизитаФормы][Ключ];
			Иначе
				Форма[Ключ] = Форма[ИмяРеквизитаФормы][Ключ];
			КонецЕсли;
