...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПоказыватьФункции = Параметры.ПоказыватьФункции;
	Если ПоказыватьФункции Тогда
		Элементы.Функции.Видимость = Истина;
		СписокФункций = ШаблоныБизнесПроцессов.СписокДоступныхФункций();
	Иначе
...
Процедура СписокФункцийВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ФункцияИсполнитель = СписокФункций.НайтиПоИдентификатору(ВыбраннаяСтрока).Представление;
