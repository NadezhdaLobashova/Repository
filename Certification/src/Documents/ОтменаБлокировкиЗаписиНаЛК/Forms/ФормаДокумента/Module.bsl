...
Процедура ПодобратьИзРасписания(Команда)
	...
	//ОткрытьФорму("Документ.ОтменаБлокировкиЗаписиНаЛК.Форма.ФормаПодбораРасписания", ПараметрыФормы, ЭтаФорма,,,, ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьВесьИнтерфейс);
	ДополнительныеПараметры = Новый Структура;
	ИмяФормыДляОткрытия = "Документ.ОтменаБлокировкиЗаписиНаЛК.Форма.ФормаПодбораРасписания";
