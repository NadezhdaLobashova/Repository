...
Процедура ОбработатьВыборСтроки(ВыбраннаяСтрока)
	...
	СтруктураВозВрата.Вставить("ДатаВремяОкончания"	, ВыбраннаяСтрока.ДатаВремяОкончания);
	СтруктураВозВрата.Вставить("Продолжительность"	, ВыбраннаяСтрока.Продолжительность);
