...
Процедура ПодобратьИзРасписания(Команда)
	...
	//ОткрытьФорму("Документ.ОтменаЗаписиНаЛК.Форма.ФормаПодбораРасписания", ПараметрыФормы, ЭтаФорма,,,, ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьВесьИнтерфейс);
	ДополнительныеПараметры = Новый Структура;
	ИмяФормыДляОткрытия = "Документ.ОтменаЗаписиНаЛК.Форма.ФормаПодбораРасписания";
