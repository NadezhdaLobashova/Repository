...
//+astyul, 74898, 01.10.2018
// процедура была в релизе 1.0.14.4 в общем молуле "Работа с уведомлениями"
// при обновлении проверить, возможно исправили
	...
	Попытка
		...
		Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
			...
			ЗадачаОбъект.СрокИсполнения = 
				?(ЗадачаОбъект.ТочкаМаршрута = БизнесПроцессы.Поручение.ТочкиМаршрута.Выполнить, 
...
Функция НаименованиеЗадачиДляПроверки()
	...
	Возврат БизнесПроцессы.Поручение.ТочкиМаршрута.Проверить.НаименованиеЗадачи + ": " + Наименование;
